...
def physicsclass():
    ...
    pywhatkit.sendwhatmsg("+91XXXXXXXXXX","Parth's class of 7:40 has started!",7,40)
...
def engclass():
    ...
    pywhatkit.sendwhatmsg("+91XXXXXXXXXX","Parth's class of English at 8:30am has started!",8,30)
...
def mathsclass():
    ...
    pywhatkit.sendwhatmsg("+91XXXXXXXXXX","Parth's class of Maths at 9:20 has started!",9,20)
...
def chemclass():
    ...
    pywhatkit.sendwhatmsg("+91XXXXXXXXXX","Parth's class of Chemistry at 10:10am has started!",7,40)
...
def Itclass():
    ...
    pywhatkit.sendwhatmsg("+91XXXXXXXXX","Parth's class of Chemistry at 10:10am has started!",7,40)
